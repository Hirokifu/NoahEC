...
class ProductController extends Controller
{
	...
	public function StoreProduct(Request $request){
		...
		$request->validate([
			'file' => 'mimes:jpeg,png,jpg,zip,pdf,cvs,xlsx,docx|max:4096',
		]);
		...
		if ($files = $request->file('file')) {
			...
			'product_name_jp' => $request->product_name_jp,
			'product_name_cn' => $request->product_name_cn,
			'product_slug_jp' =>  strtolower(str_replace(' ', '-', $request->product_name_jp)),
			'product_slug_cn' => str_replace(' ', '-', $request->product_name_cn),
			'product_code' => $request->product_code, //HSコード、9桁

			'product_qty' => $request->product_qty,
			'product_tags_jp' => $request->product_tags_jp,
			'product_tags_cn' => $request->product_tags_cn,
			'product_size_jp' => $request->product_size_jp,
			'product_size_cn' => $request->product_size_cn,
			'product_color_jp' => $request->product_color_jp,
