...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
	<tr>
		<td valign="top">
			...
			<h2 style="color: green; font-size: 26px;"><strong>Noahtime, Inc.</strong></h2>
		</td>
		<td align="right">
			<pre class="font" >
				Noahtime Head Office <br>
				E-mail: sales@noahtime.co.jp
				Mobile: +81 90 6086 9138 <br>
				post_code: 464-0804
				3-34-2 Higshiyama-motomachi
				Chikusa, Nagoya-city, Aichi,Japan <br>
...
<table width="100%">
    ...
    <tbody>
		...
		<tr class="font">
			...
			<td align="center">{{ $item->product->product_name_jp }}</td>
			<td align="center">
