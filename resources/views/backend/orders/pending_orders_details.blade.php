...
<section class="content">
    ...
    <div class="col-md-6 col-12">
        ...
        <div class="col-md-12 col-12">
            ...
            <tr>
            <td width="10%">
                <label for=""><img src="{{ asset($item->product->product_thambnail) }}" style="border-radius: 5px" height="50px;" width="60px;"> </label>
            </td>

            <td width="20%">
                <label for=""> {{ $item->product->product_name_jp }}</label>
            </td>
