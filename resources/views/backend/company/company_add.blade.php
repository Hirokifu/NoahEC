	...
	<form method="post" action="{{ route('company.store') }}" enctype="multipart/form-data" >
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="controls">
					<input type="text" name="company_jp" class="form-control" required="">
					@error('company_jp')
			...
			<div class="col-md-6">
				...
				<a>会社名称（中）</a>
				<div class="controls">
					<input type="text" name="company_cn" class="form-control">
					@error('company_cn')
					<span class="text-danger">{{ $message }}</span>
					@enderror
				</div>
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="controls">
					<input type="text" name="business_jp" class="form-control" required="">
					@error('business_jp')
					<span class="text-danger">{{ $message }}</span>
					@enderror
				</div>
			...
			<div class="col-md-6">
				...
				<a>業種（中）</a>
				<div class="controls">
					<input type="text" name="business_cn" class="form-control">
					@error('business_cn')
					<span class="text-danger">{{ $message }}</span>
					@enderror
				</div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<a>タグ（日）</a>
				<div class="controls">
					<input type="text" name="tags_jp" class="form-control" value="ラベル" data-role="tagsinput">
					@error('tag_jp')
					<span class="text-danger">{{ $message }}</span>
					@enderror
				</div>
			...
			<div class="form-group">
				<a>タグ（中）</a>
				<div class="controls">
				<input type="text" name="tags_cn" class="form-control" value="标签" data-role="tagsinput">
				@error('tag_cn')
				<span class="text-danger">{{ $message }}</span>
				@enderror
				</div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="controls">
					<input type="text" name="product_jp" class="form-control" required="">
					@error('product_jp')
					<span class="text-danger">{{ $message }}</span>
					@enderror
				</div>
			...
			<div class="form-group">
				<a>主要製品（中）</a>
				<div class="controls">
					<input type="text" name="product_cn" class="form-control">
					@error('product_cn')
					<span class="text-danger">{{ $message }}</span>
					@enderror
				</div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="controls">
					<input type="text" name="address_jp" class="form-control" required="">
					@error('address_jp')
					<span class="text-danger">{{ $message }}</span>
					@enderror
				</div>
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="controls">
					<input type="file" name="company_thambnail" class="form-control" onChange="mainThamUrl(this)" required="" >
					@error('company_thambnail')
					<span class="text-danger">{{ $message }}</span>
					@enderror
					<img src="" id="mainThmb">
				</div>
		...
		<div class="row">
			...
			<div class="form-group">
				<a>一言の説明（中）</a>
				<div class="controls">
				<textarea name="short_descp_cn" id="textarea" class="form-control" placeholder="Textarea text"></textarea>
			</div>
			</div>
