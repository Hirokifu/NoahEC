        ...
        <form method="post" action="{{ route('slider.update') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <h5>Sales_point <span class="text-danger">(ex:感謝キャンペーン)</span></h5>
                    <div class="controls">
                        <input type="text"  name="sales_point" class="form-control" value="{{ $sliders->sales_point }}" >
                    </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <input type="text"  name="user_merit" class="form-control" value="{{ $sliders->user_merit }}" >
                </div>
            </div>
