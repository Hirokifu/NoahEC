...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h4 class="box-title">ブログの新規作成</h4>
        </div>
        ...
        <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data" >
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="post_title_jp" class="form-control" required="">
                            @error('post_title_jp')
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <input type="text" name="post_title_cn" class="form-control" required="">
                            @error('post_title_cn')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <textarea id="editor1" name="post_details_jp" rows="10" cols="80" required="">
                            Post Details JP
                        </textarea>
                    </div>
                </div>
