    ...
    <div class="modal-body">
        ...
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
                <img src=" " class="card-img-top" alt="..."  style="border-radius: 8px; height: 200px; width: 200px;" id="pimage">
            </div>
        </div>

        <div class="col-md-4">
            <ul class="list-group">
                <li class="list-group-item">販売価格: <strong class="text-danger">￥<span id="pprice"></span></strong>
                    <del id="oldprice"></del>
                </li>
                <li class="list-group-item">HSコード: <strong id="pcode"></strong></li>
                <li class="list-group-item">カテゴリ: <strong id="pcategory"></strong></li>
                <li class="list-group-item">ブランド: <strong id="pbrand"></strong></li>
                <li class="list-group-item">在庫状況: <span class="badge badge-pill badge-success"     id="aviable" style="background: green; color: white;"></span>
...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        success:function(data){
            // console.log(data)
            $('#pname').text(data.product.product_name_jp);
            $('#price').text(data.product.selling_price);
            $('#pcode').text(data.product.product_code);
            $('#pcategory').text(data.product.category.category_name_jp);
            $('#pbrand').text(data.product.brand.brand_name_jp);
            ...
            success:function(response){
                ...
                $.each(response.carts, function(key,value){
                    miniCart += `<div class="cart-item product-summary">
                        <div class="row">
                        <div class="col-xs-4">
                        <div class="image"> <a href="detail.html"><img src="/${value.options.image}" alt="" style="border-radius: 8px;"></a> </div>
                        </div>
                        <div class="col-xs-7">
