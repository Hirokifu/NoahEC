...
<div class="breadcrumb">
	<div class="container">
		<div class="breadcrumb-inner">
			...
			<li class='active'>{{ $product->product_name_jp }}</li>
...
{{--
			...
			<div class="stock-container info-container m-t-8">
				<div class="row">
					...
					<div class="col-sm-9">
						...
						<div class="stock-box" style="margin:8px 0 0 0">
							<span class="value"><strong>{{ $product->product_code }}</strong></span>
						</div>

						<div class="stock-box" style="margin:8px 0 0 0">
							<span class="value"><strong>M{{ $product->brand_id }}{{ $product->category_id }}{{ $product->subcategory_id }}{{ $product->subsubcategory_id }}00{{ $product->id }}</strong></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="favorite-button">
						<a class="btn btn-danger" data-toggle="tooltip" style="float:right" title="お気に入り登録" id="{{ $product->id }}" onclick="addToWishList(this.id)"><i class="fa fa-heart"></i>
						</a>
	...
	<div class="row">
		...
		<div class="col-sm-4">
			<div class="form-group">
				@if($product->product_size_jp == null)
				@else
				{{-- <label class="info-title control-label">サイズ: <span> </span></label> --}}
