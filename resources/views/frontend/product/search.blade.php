...
@endforeach
    ...
    <!-- == ==== SECTION – HERO === ====== -->
    {{-- @php
        $slider = App\Models\Slider::where('status',1)->where('sales_point','!=',NULL)->orderBy('id','DESC')->limit(1)->get();
    @endphp --}}


    <div id="category" class="category-carousel hidden-xs">
        <div class="item">
        <div class="image"> <img src="{{ asset('frontend/assets/images/banners/cat-banner-1.jpg') }}" class="img-responsive" style="border-radius: 8px"> </div>
