                    ...
                    <div class="panel panel-default">
                        ...
                        {{-- <div class="">
                            <ul class="nav nav-checkout-progress list-unstyled">
                                ...
                                <strong>Coupon Name : </strong> {{ session()->get('coupon')['coupon_code'] }}
            ...
            <div class="col-md-6">
                <div class="checkout-progress-sidebar ">
                    <div class="panel-group">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="unicase-checkout-title">クレジットカード決済</h4>
                            </div>
...
<script type="text/javascript">
    ...
    var stripe = Stripe('pk_test_51KOdQ7JXoUfFAlu8v9XGqIs696lqJVu3vLDimtpi9d6ZL2XM3ZbXh5AbRrExI168jRWRjOq6nJuPiiUUCCwxuTlm00ueeiIdMX');
