...
<!-- ========================== SIDEBAR : END ======================= -->
  ...
  <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
    ...
    <div id="hero">
        ...
        <div class="item" style="border-radius:8px 8px 0 0; background-image: url({{ asset($slider->slider_img) }});">
    ...
    <!-- ================= SCROLL TABS : END =================== -->
        ...
        <!-- ========================= BLOG SLIDER ======================== -->
        <section class="section latest-blog outer-bottom-vs wow fadeInUp" style="border-radius:8px">
