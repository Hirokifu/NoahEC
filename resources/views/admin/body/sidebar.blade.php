    ...
    <div class="user-profile">
        <div class="ulogo">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <img src="{{ asset('backend/images/logo-dark.jpg') }}" alt="logo" width="55" height="55">
                    <h3><b>NOAH</b> HOUSE</h3>
                </div>
            </a>
        </div>
    </div>
...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="header nav-small-cap">Order Management</li>
    ...
    <li class="header nav-small-cap">Communication Center</li>
        ...
        <li class="treeview {{ ($prefix == '/faq')?'active':'' }}  ">
            ...
            <ul class="treeview-menu">
                <li class="{{ ($route == 'all.faq')? 'active':'' }}"><a href="{{ route('all.faq') }}"><i class="ti-more"></i>Add FAQ</a></li>
            </ul>
        </li>
        @else
        @endif
        ...
        <li class="treeview {{ ($prefix == '/contact')?'active':'' }}  ">
            ...
            <ul class="treeview-menu">
                <li class="{{ ($route == 'all.contact')? 'active':'' }}"><a href="{{ route('all.contact') }}"><i class="ti-more"></i>User Message</a></li>
            </ul>
        </li>
        @else
        @endif
        ...
        <li class="treeview {{ ($prefix == '/inquiry')?'active':'' }}  ">
            ...
            <ul class="treeview-menu">
                <li class="{{ ($route == 'admin.inquiry')? 'active':'' }}"><a href="{{ route('admin.inquiry') }}"><i class="ti-more"></i>Inquiry</a></li>
            </ul>
        </li>
        @else
        @endif
        ...
        <li class="treeview {{ ($prefix == '/news')?'active':'' }}  ">
            ...
            <ul class="treeview-menu">
                <li class="{{ ($route == 'news.view')? 'active':'' }}"><a href="{{ route('news.view') }}"><i class="ti-more"></i>News</a></li>
            </ul>
        </li>
        @else
        @endif
    ...
    <li class="header nav-small-cap">Store Setting</li>
        ...
        <li class="treeview {{ ($prefix == '/shipping')?'active':'' }}  ">
            ...
            <ul class="treeview-menu">
                ...
                <li class="{{ ($route == 'manage-division')? 'active':'' }}"><a href="{{ route('manage-district') }}"><i class="ti-more"></i>Ship District</a></li>
