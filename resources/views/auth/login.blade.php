        ...
        <div class="row justify-content-center no-gutters">
            <div class="col-lg-5 col-md-6 col-12">
                ...
                <div class="content-top-agile p-10">
                    <h2 class="text-white">ノアショップ<span style="font-size:15px">©</span> ログイン</h2>
                ...
                <div class="text-center" style="margin:10px 0 15px 0">
                    <p class="mt-15 mb-0 text-white">アカウントを作成する　 <a href="{{ route('register') }}" class="text-info ml-5">登録</a></p>
                </div>
